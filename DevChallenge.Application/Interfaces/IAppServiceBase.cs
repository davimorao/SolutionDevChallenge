...
namespace DevChallenge.Application.Interfaces
{
    ...
    {
        T Obter(Expression<Func<T, bool>> filter = null, params Expression<Func<T, object>>[] includes);

        /// <summary>
        /// Método responsável por adicionar multiplos objetos da entidade genérica no banco de dados.
        /// </summary>
        ...
        IEnumerable<T> Paginar(IEnumerable<T> pCollection, ref int pPaginaSolicitada, ref int pQuantidadePaginas, int pQuantidadeRegistros = 15);
        ...
        void Adicionar<TViewModel>(ref TViewModel pObj) where TViewModel : BaseViewModel;
        ...
        TViewModel Listar<TViewModel>(int pId) where TViewModel : BaseViewModel;

        /// <summary>
        /// Método responsável por retornar uma lista de objetos.
        /// </summary>
        /// <typeparam name="TViewModel"></typeparam>
        /// <returns></returns>
        IEnumerable<TViewModel> Listar<TViewModel>() where TViewModel : BaseViewModel;


        void Editar<TViewModel>(ref TViewModel pObj) where TViewModel : BaseViewModel;
    }
}
